...
const handleRoomFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
  ...
  <div className="flex gap-2 mb-3">
    ...
    <button
      ...
      className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition flex items-center gap-1 disabled:bg-blue-400 disabled:cursor-not-allowed"
    >
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex justify-end gap-2 mt-4">
                      <button
                        ...
                        className="text-sm bg-yellow-100 hover:bg-yellow-200 text-yellow-800 px-3 py-1 rounded flex items-center gap-1 transition"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className="h-4 w-4"
                      ...
                      <button
                        ...
                        className="text-sm bg-red-100 hover:bg-red-200 text-red-800 px-3 py-1 rounded flex items-center gap-1 transition"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className="h-4 w-4"
